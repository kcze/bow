...
export const CHARGER_FREEZE_S = 0.1;
...
// ─── Explosive arrow ─────────────────────────────────────────────────────────
// Multiplier is >1 on purpose: the explosion is the whole point of the
// quiver, so it should out-damage the shot it came from. Falloff floor is
// set so a 1-HP enemy anywhere in the blast reliably dies.
export const EXPLOSION_RADIUS = 75;
export const EXPLOSION_DAMAGE_MULT = 1.6;
export const EXPLOSION_MIN_FALLOFF = 0.55;
...
export const BLAZING_PATCH_DPS = 5;

// ─── Fire-patch damage caps ─────────────────────────────────────────────────
export const BLAZING_PATCH_DAMAGE_CAP = 2;

// ─── Items (all passive) ─────────────────────────────────────────────────────
export const SHIELD_REGEN_BASE = 30;
export const SHIELD_REGEN_PER_POWER = -2;

export const SHOCKWAVE_EXPAND_SPEED = 380;
export const SHOCKWAVE_MAX_RADIUS_BASE = 130;
export const SHOCKWAVE_MAX_RADIUS_PER_POWER = 25;
export const SHOCKWAVE_DAMAGE_BASE = 3.5;
export const SHOCKWAVE_DAMAGE_PER_POWER = 1.5;
...
export const EMBER_TRAIL_PATCH_DPS = 6;
export const EMBER_TRAIL_PATCH_DAMAGE_CAP = 10;
